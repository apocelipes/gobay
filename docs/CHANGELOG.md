...
- 添加方便写测试的 testhelper ，详情参考 [writing_test.md](https://github.com/apocelipes/gobay/blob/master/docs/writing_test.md)
...
// 这行，改为
github.com/apocelipes/ent v0.4.0

// 并把下面的 replace 改为
replace github.com/apocelipes/ent => github.com/shanbay/ent v0.4.0
```
